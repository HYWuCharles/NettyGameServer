...
public class MessageHandlerMulti{
    ...
    public synchronized static Map<String, Object> getPackage(int playerNumber, int frame){
...
//                System.out.println("No package found");
    ...
    public synchronized static void clientReceivePackage(int playerNumber, Map<String, Object> m) {
        // TODO: About starting
